	...
	public static void main(String[] args) {
		...
		while(contador < 15) {
			...
			if(categoria == 'C') {
				...
				System.out.printf("Valor imposto(37,41): R$%.2f\nPreço c/ impostos: R$%.2f\nValor lucro(30,00):"
						+ " R$%.2f\nPreço c/ impostos e lucro: R$%.2f",
				...
				System.out.println("Categoria inválida! Deve ser C, E ou V.");
			}
			System.out.println("\n\nDeseja cadastrar novo produto?(máximo de 15)(s/n)");
